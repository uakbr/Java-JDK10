/*
 * @(#)SecurityDialog.java	1.15 95/03/20 Sami Shaio
 *
...
=>hitting Apply leads to a safe default.";
	...
	super(f.wServer, true, false, f, 433, 425, Color.lightGray);
	...
	opt = new SecurityOptions(r, "Enter desired security mode:", this);
...
class FirewallDialog extends Frame implements ChoiceHandler {
	...
	r = new Row(cw, null, true);
	opt = new OptionMenu(r, "Entry type:", null);
	opt.addItem("Domain");
	opt.addItem("Host");
	r = new Row(cw, null, true);
