...
class String extends Object {
    ...
    private static char TRT[]; /* case folding translation table */
    static {
        char trt[] = new char[256];
        int i;
        for (i = 0; i<256; i++)
            trt[i] = (char) i;
        for (i = 'a'; i<='z'; i++)
	...
	trt[0xC1] = 0xE1;	/* A WITH ACUTE */
	trt[0xC2] = 0xE2;	/* A WITH CIRCUMFLEX */
	trt[0xC4] = 0xE4;	/* A WITH DIAERESIS */
	trt[0xC0] = 0xE0;	/* A WITH GRAVE */
	trt[0xC5] = 0xE5;	/* A WITH RING ABOVE */
	trt[0xC3] = 0xE3;	/* A WITH TILDE */
	trt[0xC7] = 0xE7;	/* C WITH CEDILLA */
	trt[0xC9] = 0xE9;	/* E WITH ACUTE */
	trt[0xCA] = 0xEA;	/* E WITH CIRCUMFLEX */
	trt[0xCB] = 0xEB;	/* E WITH DIAERESIS */
	trt[0xC8] = 0xE8;	/* E WITH GRAVE */
	trt[0xD0] = 0xF0;	/* ETH */
	trt[0xCD] = 0xED;	/* I WITH ACUTE */
	trt[0xCE] = 0xEE;	/* I WITH CIRCUMFLEX */
	trt[0xCF] = 0xEF;	/* I WITH DIAERESIS */
	trt[0xCC] = 0xEC;	/* I WITH GRAVE */
	trt[0xD1] = 0xF1;	/* N WITH TILDE */
	trt[0xD3] = 0xF3;	/* O WITH ACUTE */
	trt[0xD4] = 0xF4;	/* O WITH CIRCUMFLEX */
	trt[0xD6] = 0xF6;	/* O WITH DIAERESIS */
	trt[0xD2] = 0xF2;	/* O WITH GRAVE */
	trt[0xD8] = 0xF8;	/* O WITH STROKE */
	trt[0xD5] = 0xF5;	/* O WITH TILDE */
	trt[0xDE] = 0xFE;	/* THORN */
	trt[0xDA] = 0xFA;	/* U WITH ACUTE */
	trt[0xDB] = 0xFB;	/* U WITH CIRCUMFLEX */
	trt[0xDC] = 0xFC;	/* U WITH DIAERESIS */
	trt[0xD9] = 0xF9;	/* U WITH GRAVE */
	trt[0xDD] = 0xFD;	/* Y WITH ACUTE */
	TRT = trt;
    }
